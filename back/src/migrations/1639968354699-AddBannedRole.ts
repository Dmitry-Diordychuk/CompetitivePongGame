...
export class AddBannedRole1639968354699 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('User', 'Admin', 'PO', 'Banned')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum_old" AS ENUM('User', 'Admin', 'PO')`);
        await queryRunner.query(`ALTER TABLE "public"."users" ALTER COLUMN "role" DROP DEFAULT`);
