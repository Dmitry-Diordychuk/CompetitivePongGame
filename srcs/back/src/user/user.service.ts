...
export class UserService {
    ...
    async updateCurrentUsername(currentUserId: number, updateUserDto: UpdateUserDto): Promise<UserEntity> {
        const user = await this.getUserById(currentUserId);
    ...
    async updateCurrentUserImage(currentUserId: number, updateUserDto: UpdateUserDto): Promise<UserEntity> {
        const user = await this.getUserById(currentUserId);
